...
export default function WelcomeBanner({ name, onClose }: Props) {
  return (
    <div className="max-w-7xl mx-auto px-6">
      <div className="mt-4 mb-2 rounded-2xl bg-gradient-to-r from-red-800 to-red-600 text-white p-4 shadow-md shadow-black/30 border border-amber-500/30 flex items-center justify-between">
        <div>
